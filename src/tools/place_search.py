import os
from src.utils.place_info_service import GooglePlaceService, TavilyPlaceService
...
class PlaceSearchTool:
    def __init__(self):
        ...
        self.google_places_search = GooglePlaceService(self.google_api_key)
        self.tavily_search = TavilyPlaceService()
        self.place_search_tool_list = self._setup_place_tools()

    def _setup_place_tools(self) -> List:
